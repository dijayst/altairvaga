  ...
  return (
   ...
   <div className="bg-gray-100 p-10 relative overflow-hidden">
     ...
     <div className="bg-gray-100 p-10 relative overflow-hidden">
      ...
      {/* SVG Ellipse as Background */}
      <div className="absolute top-1/2 left-1/2 w-[1240px] -translate-x-1/2 -translate-y-1/2 z-0">
        <svg viewBox="0 0 1240 270" xmlns="http://www.w3.org/2000/svg" className="w-[90%] h-full">
          <defs>
            <linearGradient id="__lottie_element_6" x1="0" x2="1" y1="0" y2="1">
              <stop offset="0%" stopColor="#a855f7" />
              <stop offset="100%" stopColor="#7e22ce" />
      ...
      {/* Marketing Content Bubbles */}
      <div className="relative z-10 text-center">
        <div className="text-3xl font-bold text-purple-600 mb-6">02</div>
     ...
     <div className="bg-gray-100 p-10 relative overflow-hidden">
      ...
      {/* SVG Ellipse as Background */}
      <div className="absolute top-1/2 left-1/2 w-[1240px] -translate-x-1/2 -translate-y-1/2 z-0">
        <svg viewBox="0 0 1240 270" xmlns="http://www.w3.org/2000/svg" className="w-[80%] h-full">
          <defs>
            <linearGradient id="__lottie_element_6" x1="0" x2="1" y1="0" y2="1">
              <stop offset="0%" stopColor="#a855f7" />
              <stop offset="100%" stopColor="#7e22ce" />
      ...
      {/* Marketing Content Bubbles */}
      <div className="relative z-10 text-center">
        <div className="text-3xl font-bold text-purple-600 mb-6">03</div>
