...
export default function ServicesCategory() {
  ...
  return (
    <div className="bg-gradient-to-b from-purple-700 via-indigo-700 to-blue-700 p-6 font-nunito rounded-2xl w-full max-w-sm">
...
onClick={() => setSelectedService(service)}
                className={`w-7 h-7 flex items-center justify-center rounded-md ${
                  service === selectedService ? "bg-white text-blue-600" : "bg-white text-purple-600"
                }`}
>
              ➜
            </button>
